...
# Slide 1: Title
add_title_slide(prs, "Snippet Tool", "Data-as-a-Service Platform\nMarket Intelligence & Pricing Analytics")

# Slide 2: The Problem
add_content_slide(prs, "The Market Problem", [
    "Red Flag Market research is SLOW: Manual data collection takes 15-20 hours per dataset",
    "Red Flag Web scraping is RISKY: Blocked by anti-bot measures, legal/GDPR concerns",
    "Red Flag Market data is EXPENSIVE: Analyst fees + licensing costs €500-1,000+ per month",
    "Red Flag Data is STALE: By the time insights are ready, markets have already moved",
    "Check SOLUTION: Semi-automatic visual intelligence - fast, accurate, legal & scalable"
])

# Slide 3: How it Works
add_content_slide(prs, "How It Works: 3-Step Process", [
    ...
    "Accuracy: 100% validated data ready for analytics"
])
...
add_content_slide(prs, "Financial Case: Supermarket Monitoring", [
    ...
    "Your Margin: €1,600-3,000 per customer from €7,630 total savings (68-84%)"
])

# Slide 5: Revenue Model
add_content_slide(prs, "3-Stream Revenue Model", [
    "Stream 1: SaaS Subscriptions",
    "  * €50-200/month: Solo analyst tier (1 store, 100 products/week)",
    "  * €200-500/month: Enterprise tier (5+ stores, 1000+ products/week)",
    "",
    "Stream 2: Data Licensing - €500-5,000/month for aggregated market datasets",
    "Stream 3: Consulting & Custom Integration - €5,000-50,000 per deployment"
])
...
add_two_column_slide(prs, "Application #1: Retail Price Monitoring (Current)",
    ...
    [
        ...
        "Market Size: €200M+ in retail analytics annually",
        "Use Cases: Competitive pricing, promotions, margin analysis",
        "Geography: EU-wide (France, Spain, Germany, UK)"
    ],
    "Revenue Potential",
    [
        "50 customers @ €250/month = €150,000/year",
        "Data licensing: €2,000-5,000/month = €24K-60K/year",
        "Consulting: 10 engagements x €10K = €100K/year",
...
add_two_column_slide(prs, "Application #2: Real Estate Valuation",
    ...
    "Revenue Potential",
    [
        "Real estate market 3x larger than retail",
...
add_two_column_slide(prs, "Application #3: Vehicle Pricing",
    ...
    [
        ...
        "Targets: Autotrader, Cars.com, dealer sites",
...
add_two_column_slide(prs, "Application #4: Hotel Rate Monitoring",
    ...
    [
        ...
        "Revenue optimization: €10K-100K per hotel chain",
        "TOTAL: €450K-700K Year 1"
    ])

# Slide 10: Scalability
add_content_slide(prs, "The Scalability Advantage", [
    "Reusable Core: Screenshot overlay + OCR + metadata pipeline works across ALL industries",
    ...
    "",
    "Year 1 Revenue Path:",
    "  Q1-Q2: Focus retail (€150K) | Q3: Real estate (€250K) | Q4: Automotive (€400K) | Year 2: €1-2M"
])

# Slide 11: GTM Strategy
add_content_slide(prs, "Go-to-Market Strategy", [
    "Phase 1 (Months 1-3): Refine retail, land 10-15 customers + build case studies",
    "",
    ...
    "  => Multi-industry = enterprise pricing (€5K+/month)",
    "",
    "Phase 4 (Year 2): Launch data licensing & analytics SaaS layer"
])

# Slide 12: Competitive Advantages
add_content_slide(prs, "Why Snippet Tool Wins", [
...
add_content_slide(prs, "5-Year Financial Projections", [
    "Year 1: €275K revenue | €175K gross profit (64% margin)",
    "Year 2: €850K revenue | €600K gross profit (71% margin)",
    "Year 3: €2.1M revenue | €1.65M gross profit (79% margin)",
    "Year 4: €4M revenue | €3.3M gross profit (83% margin)",
    "Year 5: €8M+ revenue | 85%+ margin (data licensing focus)"
])

# Slide 14: Implementation Roadmap
add_content_slide(prs, "6-Month Implementation Roadmap", [
    "Month 1: Polish retail MVP, 2-3 pilot customers",
    "Month 2: Real estate module dev + 5-10 retail customers",
    "Month 3: Launch real estate beta + 20 retail customers",
    "Month 4: Automotive dev + Enterprise tier launch (€5K+/month)",
...
add_title_slide(prs, "Transform Data Collection into Revenue",
    "From €7,630 annual cost savings\nto €8M+ recurring revenue in 5 years")

# Save presentation
output_path = r"C:\Users\emman\p_Claude\devs\snipper_tool\Snippet_Tool_DaaS_Pitch.pptx"
